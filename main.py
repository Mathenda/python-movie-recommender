...
# Loop over the pages you want to get
for page in range(1, 6):  # This will get pages 1 to 5
    ...
    df = pd.DataFrame(data['results'])  # 'results' is the key containing the list of movies
...
all_data_df.to_csv('lab4/movies.csv', index=False)